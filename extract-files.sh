...
patch_sym _ZN7android19GraphicBufferMapper4lockEPK13native_handleiRKNS_4RectEPPv _ZN7android19GraphicBufferMapper4lockEPK13native_handlejRKNS_4RectEPPv ${VENDOR_OUT}/lib64/hw/hwcomposer.mt8173.so
