...
BOARD_HOSTAPD_PRIVATE_LIB := lib_driver_cmd_mt76xx
BOARD_WPA_SUPPLICANT_DRIVER := NL80211
BOARD_WPA_SUPPLICANT_PRIVATE_LIB := lib_driver_cmd_mt76xx
WIFI_DRIVER_FW_PATH_PARAM := "/sys/kernel/debug/mtwifi/wlan0/fwpath"
WIFI_DRIVER_FW_PATH_STA := STA
WIFI_DRIVER_FW_PATH_AP := AP
WIFI_DRIVER_FW_PATH_P2P := P2P
WIFI_DRIVER_STATE_CTRL_PARAM := "/sys/kernel/debug/mtwifi/wlan0/fwpath"
...
TARGET_LD_SHIM_LIBS := \
	...
	/system/vendor/bin/hw/wpa_supplicant|libshim_wpa.so \
	/system/vendor/bin/wpa_cli|libshim_wpa.so \
	/system/vendor/lib/libwpa_supplicant.so|libshim_wpa.so \
	/system/vendor/lib64/libwpa_supplicant.so|libshim_wpa.so
